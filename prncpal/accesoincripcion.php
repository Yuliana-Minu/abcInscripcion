...
<html lang="en">
  ...
  <body>
    <form class="form-signin" role="form" id="inscripcionform">
        <div class="text-center mb-4">
            <img class="mb-4" src="images/logo.jpeg"  style="width: 50%; height: 50%"  alt="" >
            <h1 class="h4 mb-4 font-weight-normal">ABC Inscripci&oacute;n</h1>
        </div>
      ...
      <button class="btn btn-success btn-lg btn-danger btn-block" type="submit" style="background-color: #e53441;" onClick="validar_inscripcion();" >Entrar</button>
...
<script src="vjs/vldar_inscripcion.js"></script>
