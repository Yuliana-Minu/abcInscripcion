...
if($codigo_persona){
    ...
    foreach($rspersona as $data_persona){
        ...
        $dba_estrato=$data_persona['dba_estrato'];
    }
...
<form id="niniosform" role="form">
    ...
    <div class="modal-body">
        ...
        <div class="partedos">
            <?php include('frma/objfrm/prsna/nnios.php'); ?>
        </div>
    </div>
    <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-danger btn-sm" onClick="validar_ninio();"><i class="far fa-save"></i> Guardar</button>
    </div>
</form>

<script src="js/jquery.validate.min.js"></script>
<script src="vjs/registroNinio.js"></script>
