...
class RgstroPdre  extends Persona{
    ...
    public function insertPadre(){
        ...
        $insertPersona="INSERT INTO principal.persona(
                                    ...
                                    per_segundonombre, per_aleatoreo)
                            VALUES (".$this->codigoPersona.", '".$this->getNombrePersona()."', '".$this->getPrimerapellidoPersona()."',
                                    ...
                                    '".$this->getSegundoNombrePersona()."', ".$this->aleatoreo.");";
        ...
        $insertDatosBasicos="INSERT INTO principal.datos_basicos(
                                        ...
                                        dba_estado, dba_fechacreo,
                                        dba_fechamodifico, dba_personacreo, 
                                        dba_personamodifico)
                                VALUES (".$this->codigoDatosBasicos.",".$this->codigoPersona.",
                                        ".$this->getRhPersona().", '".$this->getDireccionPersona()."',
                                        ".$this->getMunicipioResidenciaPersona().", '".$this->getCorreoPersona()."', 
                                        '".$this->getTelefonoPersona()."', ".$this->getCelularPersona().",
                                        1, NOW(),
        ...
        //echo "---> Clave Persona: ".$claveInsertar."<br><br>";
