...
class UpdtePrsnaPrfil  extends PersonaPerfil{
    ...
    public function updatePersonaPerfil(){
        ...
        for($inicioInsert=0; $inicioInsert<$cantidadInsert; $inicioInsert++){
            ...
            $insertPerfil[$inicioInsert]="INSERT INTO principal.persona_perfil(
                                                      ppe_codigo, ppe_persona, ppe_perfil, ppe_estado, 
                                                      ppe_fechacreo, ppe_fechamodifico, ppe_personacreo,
                                                      ppe_personamodifico)
                                              VALUES (".$codigoPersonaPerfil.", ".$this->getPersonaPersonaPerfil().", ".$perfiles[$inicioInsert].",1, 
