<?php 
    ...
    class VldacionPdre extends Inscripcion{
        private $codigoPapa;
        ...
        public function datos_padres_existencia($codigo_persona){
            ...
            while($data_datos_padres_existencia=$this->cnxion->obtener_filas($query_datos_padres_existencia)){
                $datadatos_padres_existencia[]=$data_datos_padres_existencia;
            }
            return $datadatos_padres_existencia;
        }
        ...
        public function info_papa(){
            ...
            $identificacion = $this->getIdentificacionPadre();
            ...
            if($buscar_si_existe){
                ...
                $dtos_padres_existencia = $this->datos_padres_existencia($buscar_si_existe);
                ...
                $papa_nininio = $this->ninio_padres($this->getCodigoEstudiante(), 1);
                ...
                if($papa_nininio==""){
                    $insertPapaNinio="INSERT INTO principal.papas_ninios(
                                          ...
                                          VALUES (".$this->codigoPapaNinio.", ".$buscar_si_existe.", 
                    ...
                    if($buscar_si_existe == $papa_nininio){
                        ...
                        $cambioPapaNinio="UPDATE principal.papas_ninios 
                        ...
                        $this->cnxion->ejecutar($cambioPapaNinio);
                    }
                }
