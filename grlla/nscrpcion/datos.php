...
<!--<div class="row">
    <div class="col-sm-12 modal-header" style="color: #0c438f;"><h1>Datos de la Inscripci&oacute;n</h1></div>
</div>

<div class="row">
    <div class="col-sm-12" style="padding-top: 10px; text-align: right; ">
        <button type="button" style="width: 140px" class="btn btn-danger btn-sm" onClick="imprimir();" title="Documento"><strong><i class="far fa-file-pdf"></i></i> &nbsp;&nbsp;Imprimir </strong></button>
    </div>
</div>-->
<div class="row">
    <div class="col-sm-12 modal-header" style="color: #0c438f;"><h1>Datos de la Inscripci&oacute;n</h1></div>
    ...
    <div class="col-sm-12" id="Padre">
            ...
            ?>  
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td rowspan="7"><img src="<?php echo $per_foto;?>" alt="<?php echo $nombre_completo; ?>" width="300"></td>
                    </tr>
                    <tr>
            ...
            <div class="col-sm-12">
                ...
                <table class="table table-bordered table-striped">
                    <tr>
                        ...
                        <td rowspan="7"><img src="<?php echo $per_fotoPapa;?>" alt="<?php echo $nombre_papito; ?>" width="300"></td>
                    </tr>
                    <tr>
            ...
            <div class="col-sm-12">
                ...
                <table class="table table-bordered table-striped">
                    <tr>
                        ...
                        <td rowspan="7"><img src="<?php echo $per_fotoMama;?>" alt="<?php echo $nombre_mamita; ?>" width="300"></td>
                    </tr>
                    <tr>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <hr style="border: 2px solid red; ">
                <?php 
                    $datos_recomendacion=$objRsInscripcion->datos_recomendacion($personaSistema);
