		...
		<div  class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-9 container-principal">
					<div class="row">
						<div class="col-sm-12 modal-header"><h1>Ni&ntilde;os de Inscripci&oacute;n</h1></div>
					</div>
					...
					<div class="row">
						<div class="col-sm-12" id="NinioInscripcion" style="padding-top: 10px; overflow: auto;">
							<?php include('grlla/dta/nscrpcion/nniosinscrpcion.php'); ?>
						</div>
					</div>					
		   		</div>
			</div>
