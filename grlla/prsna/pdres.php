		...
		<div  class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-9 container-principal">
					<div class="row">
						<div class="col-sm-12 modal-header"><h1>Papitos</h1></div>
					</div>
					
					<div class="row">
						<div class="col-sm-12" style="padding-top: 10px; text-align: right; ">
							<button type="button" style="width: 180px" class="btn btn-danger btn-sm" onClick="agregar();" title="Nuevo Docente"><i class="fas fa-plus"></i> Nuevo Padre </button>
						</div>
					</div>

					<div class="row">
						<div class="col-sm-12" id="Padre" style="padding-top: 10px; overflow: auto;">
							<?php include('grlla/dta/prsna/pdres.php'); ?>
						</div>
					</div>					
		   		</div>
			</div>
