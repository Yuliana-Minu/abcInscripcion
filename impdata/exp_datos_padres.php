...
//$archivo = "dataSubir/2018/1.xlsx";

$archivo = "dataSubir/m11_1.xlsx";
...
for ($row = 2; $row <= $highestRow; $row++){
  ...
  $identy=str_replace('"','',$identificacion);

  $ide=str_replace(',','',$identy);

  /*$clavePersona=sha1($ide);
  ...
  $claveInsertar=passwrd($clavePersona);*/
    ...
    $sql_perfil="INSERT INTO principal.persona_tipopersona(
                    ...
                    VALUES ($tipo_persona, 4, $per_codigo,
                            1, NOW(), NOW(),
                            1, 1);";
